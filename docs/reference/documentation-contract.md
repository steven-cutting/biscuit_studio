...
Enforced by `bg-validate-docs`, a console script of the `biscuit-games-tooling` package, run
by `just check-docs` and by a pre-commit hook. It reports every violation at once rather
